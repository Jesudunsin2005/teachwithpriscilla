          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-4">
                ...
                <Link href="/admin/posts" className="text-gray-700 hover:text-gray-900 px-3 py-2 text-sm font-medium">
                  Blog Posts
                </Link>
                <Link
            ...
            <div className="flex items-center space-x-4">
              <span className="text-gray-700 text-sm">Welcome, {session.user.email}</span>
              <form action={signOut}>
